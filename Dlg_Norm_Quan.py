...
class Norm_Quan_Dialog(object):
    def setupUi(self, Dialog):
        Dialog.setObjectName(_fromUtf8("Dialog"))
        Dialog.resize(376, 225)
        ...
        self.normProbs = QtGui.QLineEdit(Dialog)
        self.normProbs.setObjectName(_fromUtf8("normProbs"))
        self.gridLayout.addWidget(self.normProbs, 0,1,1,1)
